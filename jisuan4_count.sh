...
do
	...
	num1=`hadoop fs -count -q /music/compress/music_log/event_day=201604${k}/event_hour=*/event_log_source=${i} | awk '{print $5,$6}' | awk '{num+=$2} END {print num}'`
	echo $i,$k,$num,$num1  >> /home/work/temp/yujie/20161222_1/result4_count.txt
	done
done
