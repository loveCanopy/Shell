...
do
	for k in ${event_day[@]}
	do
	num=`hadoop fs -ls bos://bigdata2/music/compress/music_log/event_day=201607${k}/event_hour=*/event_log_source=${i} | awk '/bos/{print $3,$6}' | awk '{num+=$1} END {print num}'`
	num1=`hadoop fs -ls /music/compress/music_log/event_day=201607${k}/event_hour=*/event_log_source=${i} | awk '/music/{print $5,$7}' | awk '{num+=$1} END {print num}'`
	echo $i, $k,$num,$num1  >> /home/work/temp/yujie/20161222_1/result7_day.txt
	done
done 
