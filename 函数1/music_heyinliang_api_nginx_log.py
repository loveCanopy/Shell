...
#################
#Author：tongyue
#Description：切分music_heyinliang_api_nginx_log日志
...
class Main(object):
    def main(self):
        ...
        # line='10.17.94.231 - - [11/Aug/2016:15:03:43 +0800] "GET /hevoice/oauth/get_token_info?token=0236bda7-c9f3-434a-826e-9ffdafa84a08 HTTP/1.0" 200 218 "-" "login_token=0236bda7-c9f3-434a-826e-9ffdafa84a08;login_type=2" "-" 0.319 0223007910 10.17.94.231 192.168.1.232 192.168.3.102:7999 10.16.92.129 "-" - - 02230079103892422848081115 1470899023.008 "-"'
        # # remove leading and trailing whitespace
        # log = line.strip('\n')
        # #去掉前后空格
        # log = log.strip()
