...
do
	...
	num1=`hadoop fs -ls /music/compress/music_log/event_day=201605${k}/event_hour=*/event_log_source=${i} | awk '/music/{print $5,$7}' | awk '{num+=$1} END {print num}'`
	echo $i, $k,$num,$num1 '\n' >> /home/work/temp/yujie/20161222_1/result5_day.txt
	done
done 
